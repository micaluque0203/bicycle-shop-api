...
from api.schemas.parts import PartResponse, UpdatePartRequest
...
async def update_part(
    ...
    part: UpdatePartRequest,
    repository=Depends(get_parts_repository),
):
    part_command = UpdatePartCommand(part_id=part_id, **part.model_dump())
    result = await update_part_command(part_command, repository)
